...
| `MIRROR_BACKENDS` | `mirrorS3,mirrorS3Replica,mirrorGCS` | A comma-separated list of backend overrides to collect metrics for. |
| `STATUS_CHECK_REFRESH_INTERVAL` | `4h` | The interval refresh the metrics. Defaults to 4h |
